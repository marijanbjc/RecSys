...
Рекомендательная система для фильмов и сериалов, построенная на комбинации контентных признаков и данных о пользовательских предпочтениях (лайках/дизлайках). 
Проект реализован в рамках финального задания курса по рекомендательным системам Karpov Courses HardML (https://karpov.courses/ml-hard).
